...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Для каждого ТекСтрокаТовары Из Товары Цикл
		...
		Если Строка = Неопределено Тогда  
			...
			// 1. Получаем коэффициент (если не заполнен, считаем равным 1)
		Коэффициент = 1;
		Если ЗначениеЗаполнено(ТекСтрокаТовары.ЕдиницаИзмерения) Тогда
			Коэффициент = ТекСтрокаТовары.ЕдиницаИзмерения.Коэффициент;
		КонецЕсли;
		
		// 2. Рассчитываем количество в базовых единицах
		КоличествоВБазовыхЕдиницах = ТекСтрокаТовары.Количество * Коэффициент;
			...
			Движение.Количество = КоличествоВБазовыхЕдиницах;
